    ...
    >
      ...
      <div className="absolute inset-0">
        <video
          ...
          poster="/hero-vessel.png"
        >
          <source src="/videos/cargaseca_hero.mp4" type="video/mp4" />
        </video>
        {/* Dark/navy overlay — 60% opacity to keep video visible but readable */}
        <div className="absolute inset-0 bg-[var(--ocean-deep)]/62" />
        {/* Gradient reinforcement at left and bottom for text legibility */}
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--ocean-deep)]/70 via-[var(--ocean-deep)]/30 to-transparent" />
